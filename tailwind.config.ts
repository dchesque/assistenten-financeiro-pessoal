		...
		extend: {
			...
			colors: {
				...
				status: {
					...
					processando: 'hsl(var(--status-processando))'
				}
			},
			backgroundImage: {
				'gradient-primary': 'var(--gradient-primary)',
				'gradient-empresa': 'var(--gradient-empresa)',
				'gradient-sucesso': 'var(--gradient-sucesso)',
				'gradient-erro': 'var(--gradient-erro)',
				'gradient-aviso': 'var(--gradient-aviso)',
			},
			boxShadow: {
