...
export default function Relatorios() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      ...
      {/* Page Header */}
      <PageHeader
        breadcrumb={createBreadcrumb('/relatorios')}
        title="Relatórios"
        subtitle="Relatórios financeiros detalhados • Análises e insights"
      />

      <div className="p-4 lg:p-8 space-y-6">
        <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center shadow-lg">
          <p className="text-muted-foreground">Relatórios financeiros detalhados</p>
