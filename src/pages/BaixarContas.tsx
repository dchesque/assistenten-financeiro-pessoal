...
export default function BaixarContas() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      ...
      <PageHeader
        breadcrumb={createBreadcrumb('/baixar-contas')}
        title="Baixar Contas"
        subtitle="Efetuar pagamentos e baixas de contas • Controle de quitação"
      />

      <div className="p-4 lg:p-8 space-y-6">
        <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center shadow-lg">
          <p className="text-muted-foreground">Efetuar pagamentos e baixas de contas</p>
