    ...
    <PageContainer>
      <div className="space-y-6">
        ...
        <PageHeader 
          ...
          subtitle="Cadastre uma nova conta a pagar no sistema"
          actions={
            <Button 
              variant="outline" 
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.forma_pagamento && <p className="text-sm text-red-600">{errors.forma_pagamento}</p>}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {formData.percentual_juros > 0 && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-red-600">+ {formatCurrency(formData.valor_original * formData.percentual_juros / 100)}</span>
                      </div>
                    )}
                    ...
                    {formData.percentual_desconto > 0 && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-green-600">- {formatCurrency(formData.valor_original * formData.percentual_desconto / 100)}</span>
                      </div>
                    )}
