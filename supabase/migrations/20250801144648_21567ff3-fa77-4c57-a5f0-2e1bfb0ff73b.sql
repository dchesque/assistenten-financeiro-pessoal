-- Remover função conflitante se existir
DROP FUNCTION IF EXISTS public.criar_lote_contas_transacional(JSON, JSON);

-- =========================================
-- FUNÇÃO TRANSACIONAL PARA LANÇAMENTO EM LOTE - V2
-- =========================================
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO public.contas_pagar (
      ...
      banco_id, user_id, data_emissao, data_lancamento
    ) VALUES (
      ...
      COALESCE(conta_record.data_lancamento, CURRENT_DATE)
...
REVOKE ALL ON FUNCTION public.processar_lote_contas_completo FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.processar_lote_contas_completo TO authenticated;