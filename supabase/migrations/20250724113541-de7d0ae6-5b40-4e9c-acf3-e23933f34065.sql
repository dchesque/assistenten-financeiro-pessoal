-- Migration 1: Plano de Contas (Base do Sistema) - CORRIGIDO
...
CREATE TABLE plano_contas (
  ...
  tipo_dre VARCHAR(30) CHECK (tipo_dre IN ('receita', 'custo', 'despesa_operacional', 'despesa_administrativa', 'despesa_comercial', 'despesa_financeira', 'outras_receitas', 'outras_despesas')),
