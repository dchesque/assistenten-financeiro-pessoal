-- Corrigir tipo de lote_id de TEXT para UUID na função processar_lote_contas_completo
...
DECLARE
  ...
  lote_id UUID;  -- Mudança: de TEXT para UUID
  conta_record RECORD;
...
BEGIN
  ...
  lote_id := gen_random_uuid();  -- Mudança: removido ::TEXT
  ...
  RETURN jsonb_build_object(
    'sucesso', true,
    'lote_id', lote_id::TEXT,  -- Converter para texto apenas no retorno
